   ...
   INCLUDE('MENUStyle.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('SCHOOL001.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('SCHOOL002.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('SCHOOL003.INC'),ONCE        !Req'd for module callout resolution
                     END
...
AppFrame             APPLICATION('Mars University'),AT(,,400,266),FONT('MS Sans Serif',8,COLOR:Black),RESIZE,ALRT(MouseLeft2), |
  CENTER,ICON('_SoftVUn.ico'),IMM,MAX,HLP('~TopSpeedUniversity'),STATUS(-1,80,120,45),SYSTEM, |
  WALLPAPER('SoftV-u.bmp')
