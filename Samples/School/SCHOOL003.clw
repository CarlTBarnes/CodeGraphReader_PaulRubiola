   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('SCHOOL003.INC'),ONCE        !Local module procedure declarations
                     END
...
window               WINDOW,AT(,,209,109),FONT('MS Sans Serif',8,COLOR:Black,FONT:regular),NOFRAME,CENTER,GRAY, |
  MDI,PALETTE(256)
                       ...
                       STRING('Mars University'),AT(11,18,188,20),USE(?String2),FONT('Arial',18,COLOR:Red,FONT:bold+FONT:italic), |
  CENTER
...
ReturnValue          BYTE,AUTO
  ...
  Do DefineListboxStyle
  TARGET{Prop:Timer} = 400                                 ! Close window on timer event, so configure timer
